...
def login_page():
    ...
    try:
        connector = mysql.connector.connect(user='root', password='123', host='127.0.0.1', database='mydatabase')
    ...
    try:
        ...
        sql_command = "Select * From userinfo Where username = '%s' And password = '%s'" % (username, password)
